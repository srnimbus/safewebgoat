<%@ page contentType="text/html; charset=ISO-8859-1" language="java" 
	import="br.com.srnimbus.safewebgoat.session.*, br.com.srnimbus.safewebgoat.lessons.Category, br.com.srnimbus.safewebgoat.lessons.AbstractLesson, br.com.srnimbus.safewebgoat.util.*, java.util.*" 
	errorPage=""  %>
<%
...
<%@page import="br.com.srnimbus.safewebgoat.lessons.RandomLessonAdapter"%>
